...
Options:
  ...
  -template        Treat migration files as go text templates; template functions are available from the
                     sprout package (https://pkg.go.dev/github.com/go-sprout/sprout).
